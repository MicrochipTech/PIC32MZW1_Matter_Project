...
#define CHIP_DEVICE_PLATFORM_CONFIG_INCLUDE <platform/wfi32/CHIPDevicePlatformConfig.h>
#define CHIP_USE_TRANSITIONAL_COMMISSIONABLE_DATA_PROVIDER 1
#define CHIP_DEVICE_LAYER_TARGET_WFI32 1
#define CHIP_DEVICE_LAYER_TARGET wfi32
