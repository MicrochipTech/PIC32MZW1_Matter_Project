...
#define MBEDTLS_PLATFORM_MEMORY
    ...
    extern void * mbedtlsPlatCAlloc(size_t aNum, size_t aSize);
    extern void mbedtlsPlatFree(void * aPtr);

    #define MBEDTLS_PLATFORM_CALLOC_MACRO mbedtlsPlatCAlloc
    #define MBEDTLS_PLATFORM_FREE_MACRO mbedtlsPlatFree
/**
