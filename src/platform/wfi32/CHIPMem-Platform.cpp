...
static void VerifyInitialized(const char * func)
{
    if (!memoryInitialized)
    {
        ...
        printf("ABORT: chip::Platform::%s() called before chip::Platform::MemoryInit()\r\n", func);
        abort();
    }
}
...
extern "C" void * mbedtlsPlatCAlloc(size_t aNum, size_t aSize)
{
    return CHIPPlatformMemoryCalloc(aNum, aSize);
}

extern "C" void mbedtlsPlatFree(void * aPtr)
{
