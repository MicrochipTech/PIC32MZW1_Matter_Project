...
#define CHIP_DEVICE_CONFIG_WIFI_AP_CHANNEL WDRV_PIC32MZW_CID_2_4G_CH1   //1
#define CHIP_DEVICE_CONFIG_WIFI_AP_SECURITY WDRV_PIC32MZW_AUTH_TYPE_OPEN
...
#define CHIP_DEVICE_CONFIG_DEFAULT_STA_SECURITY WDRV_PIC32MZW_AUTH_TYPE_WPAWPA2_PERSONAL
