...
class PIC32ScanResponseIterator : public Iterator<WiFiScanResponse>
{
public:
    PIC32ScanResponseIterator(const size_t size) : mSize(size) {}
...
class PIC32WiFiDriver final : public WiFiDriver
{
public:
    class WiFiNetworkIterator final : public NetworkIterator
    {
    public:
        WiFiNetworkIterator(PIC32WiFiDriver * aDriver) : mDriver(aDriver) {}
    ...
    //uint8_t ConvertSecuritytype(cy_wcm_security_t security);
    ...
    static PIC32WiFiDriver & GetInstance()
    {
        static PIC32WiFiDriver instance;
        return instance;
    }
