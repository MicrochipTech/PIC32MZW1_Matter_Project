# Introduction
This project add the support of Microchip PIC32MZW1 Wi-Fi MCU module to the Matter protcol reposistory.  
To quickly get start the PIC32MZW1 example, you can go to the [PIC32MZW1 lighting-app]() page
